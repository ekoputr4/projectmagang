...
{
	return "<div class='alert alert-success alert-block'><button data-dismiss='alert' class='close'></button><h4 class='alert-heading'>Sukses!</h4>".$data."</div>";
}
...
function getSession($param){
    $CI =& get_instance();
    $sess = $CI->session->userdata('sess_cbham');
    return $sess[$param];
}
